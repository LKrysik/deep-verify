...
Your output MUST follow the `product-brief` contract:

1. Save to: `{output_folder}/product-brief.md`
2. Include YAML frontmatter with required fields: `id`, `name`, `status`, `version`
3. Include required sections: `Vision`, `Target Users`, `Core Problem`, `Success Metrics`, `MVP Scope`
