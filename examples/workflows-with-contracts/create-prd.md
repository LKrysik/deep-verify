...
output_contract: prd
next:
  success: create-architecture
  failure: retry
status: pending

# === EXISTING BMAD FIELDS ===
...
Your output MUST follow the `prd` contract:

1. Save to: `{output_folder}/prd.md`
2. Include YAML frontmatter with required fields: `id`, `name`, `status`, `version`, `product_brief`
3. Include required sections: `Overview`, `Goals & Success Metrics`, `User Personas`, `Functional Requirements`, `Non-Functional Requirements`, `MVP Scope`
